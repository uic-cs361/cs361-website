...
layout: default
date: 2021-10-25T17:00:00-6:00
gradescope_quiz: https://www.gradescope.com/courses/293389/assignments/1598943
hw4_assignment: https://classroom.github.com/a/2GVv4WoH
---
...
1.  In this lab, we will be building a garbage collector for malloc. As usual, you should start by going to <Link to={frontMatter.gradescope_quiz}>Gradescope</Link> and skimming the questions. Also, this lab will be walking through fundamental parts of the homework, so please (if you haven’t already) go to the course page, accept the <Link to={frontMatter.hw4_assignment}>Homework 4</Link> assignment, and get the skeleton code. 
